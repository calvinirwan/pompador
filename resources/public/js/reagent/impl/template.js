...
{return (function() { 
var G__5597__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3558__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3558__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5600 = res;(G__5600[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5600;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5601){var vec__5603 = p__5601;var id = cljs.core.nth.call(null,vec__5603,(0),null);var class$ = cljs.core.nth.call(null,vec__5603,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5604 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5604 === "key")))
{(o[pname_5604] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5607 = jsprops;(G__5607["defaultValue"] = value);
(G__5607["value"] = null);
(G__5607["onChange"] = ((function (G__5607,on_change,value){
return (function (p1__5605_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5605_SHARP_);
});})(G__5607,on_change,value))
);
return G__5607;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__5609 = spec;(G__5609["componentDidUpdate"] = ((function (G__5609){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__5609))
);
(G__5609["componentWillUnmount"] = ((function (G__5609){
...
return (function (p1__5610_SHARP_,p2__5611_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__5610_SHARP_,p2__5611_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5613 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5613,(0),null);var id = cljs.core.nth.call(null,vec__5613,(1),null);var class$ = cljs.core.nth.call(null,vec__5613,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5615 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5615,(0),null);var id_class = cljs.core.nth.call(null,vec__5615,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5619 = {};(obj5619[reagent.impl.util.cljs_argv] = v);
(obj5619[reagent.impl.util.cljs_level] = level);
return obj5619;
})();var k_5620 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5621 = (((k_5620 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5620);if((k_SINGLEQUOTE__5621 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5621);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4414__auto___5622 = a.length;var i_5623 = (0);while(true){
if((i_5623 < n__4414__auto___5622))
{(a[i_5623] = reagent.impl.template.as_component.call(null,(a[i_5623]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4414__auto___5625 = a.length;var i_5626 = (0);while(true){
if((i_5626 < n__4414__auto___5625))
{if((i_5626 >= first_child))
{(a[i_5626] = reagent.impl.template.as_component.call(null,(a[i_5626]),level));
} else
{}
{
