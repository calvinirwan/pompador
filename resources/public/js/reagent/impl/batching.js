...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3558__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3558__auto__))
...
{var C_5594 = (a[i]);if(cljs.core.truth_(C_5594.cljsIsDirty))
{C_5594.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5596 = C.cljsRatom;if(!((ratom_5596 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_5596);
} else
{}
